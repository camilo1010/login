...
class SigninNatural extends CI_Controller {
	...
	function sign(){
		...
		$this->form_validation->set_rules('sexo', 'sexo', 'trim|required|alpha|min_length[4]|max_length[30]|xss_clean');
		$this->form_validation->set_rules('direccion', 'direccion', 'trim|required|alpha_numeric|min_length[6]|max_length[20]|xss_clean');
		$this->form_validation->set_rules('pais', 'pais', 'trim|alpha|required|min_length[4]|max_length[20]|xss_clean');
		...
		$this->form_validation->set_rules('correo', 'correo', 'trim|required|valid_email|min_length[6]|max_length[12]|matches[passwordC]|xss_clean');
